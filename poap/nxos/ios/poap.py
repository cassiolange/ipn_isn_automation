#!/bin/env python3
#md5sum="d5ab34af49216ded9e2de74fac94c72f"
"""
...
options = {
   "username": "nxosuser",
   "password": "9yc2gaaR1G1uoo",
   "hostname": "10.0.0.1",
   "transfer_protocol": "scp",
   "mode": "serial_number",
   "target_system_image": "nxos64.10.2.1.F.bin",
}
...
def set_defaults_and_validate_options():
    ...
    set_default("config_path", "/bootflash:/poap/")
    # Target image and its path (single image is default)
    set_default("target_system_image", "")
    set_default("target_image_path", "/bootflash:/poap/")
